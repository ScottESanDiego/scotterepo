...
https://github.com/NVIDIA/container-toolkit/archive/v1.1.2.tar.gz -> container-toolkit.tar.gz"
...
src_unpack() {
	...
	mkdir "${WORKDIR}/nvidia-container-runtime/toolkit/" || die
	mv "${WORKDIR}/container-toolkit-1.1.2/pkg" "${WORKDIR}/nvidia-container-runtime/toolkit/nvidia-container-toolkit" || die
