...
IUSE="acpi compat +driver gtk3 kernel_FreeBSD kernel_linux opencl +kms +libglvnd multilib static-libs +tools uvm wayland +X"
...
src_install() {
	...
	if use kernel_linux; then
			...
			donvidia ${NV_OBJ}/libnvidia-ml.so.${NV_SOVER}
			# No Dependencies
			donvidia ${NV_OBJ}/libcuda.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-allocator.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-cbl.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-fatbinaryloader.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-glcore.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-glvkspirv.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-glsi.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-opticalflow.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-opencl.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-ptxjitcompiler.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libvdpau_nvidia.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvoptix.so.${NV_SOVER}
 			donvidia ${NV_OBJ}/libnvidia-tls.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-rtcore.so.${NV_SOVER}
			# Used by nvidia-container-cli
			donvidia ${NV_OBJ}/libnvidia-compiler.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-eglcore.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libnvidia-ifr.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libGLX_nvidia.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libEGL_nvidia.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libGLESv2_nvidia.so.${NV_SOVER}
			donvidia ${NV_OBJ}/libGLESv1_CM_nvidia.so.${NV_SOVER}
	fi
